    ...
    return (
        ...
        <section className="form-container">
            <form className="form-signin" onSubmit={handleAddProject}>
                ...
                <button className="btn btn--accent btn--form" type="submit">Dodaj</button>
            </form>
                </section>
            ...
            <div id="projectList">
                {projects.map((project) => (
                    <div key={project.id}>
                        ...
                        <button className="edit-btn" onClick={() => handleEditProject(project.id)}>Edytuj</button>
                        <button className="delete-btn" onClick={() => handleDeleteProject(project.id)}>Usuń</button>
                    </div>
                ))}
            </div>
            </>
